...
class MedicineAdd extends React.Component {
  constructor() {
    super(props);
    this.state = { name: "", type: "", frequency: "", intakeTime: "", formData: null };
  ...
  handleFormSubmit(e) {
    e.preventDefault();
    this.refs.frmAddMedicine.reset();
  }
    ...
    return (
      <div className="container">
        ...
        <div className="form-container">
          <form className="form" ref="frmAddMedicine" onSubmit={this.handleFormSubmit}>
